...
export const KPI_ACCENT: Record<KpiAccent, KpiAccentStyle> = {
  amber: {
    ...
    footerText: 'text-amber-800 dark:text-amber-200',
  ...
  emerald: {
    ...
    footerText: 'text-emerald-800 dark:text-emerald-200',
  ...
  sky: {
    ...
    footerText: 'text-sky-800 dark:text-sky-200',
  ...
  violet: {
    ...
    footerText: 'text-violet-800 dark:text-violet-200',
