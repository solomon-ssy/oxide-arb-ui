...
export function useParityRunColumns(
  ...
  return [
      ...
      cellRender: {
        ...
        props: {
          ...
          to: (row: FeatureParityRunView) =>
            `/research/feature-integrity?run_id=${row.parity_run_id}`,
        },
      },
      field: 'parity_run_id',
      minWidth: 160,
    ...
    },
    {
      cellRender: {
        name: 'CellTag',
        options: useFeatureParityRunKindTagOptions(),
      },
      field: 'kind',
    ...
    },
    {
      cellRender: {
        name: 'CellTag',
        options: useFeatureParityRunStatusTagOptions(),
      },
      field: 'status',
  ...
  return [
    {
      cellRender: {
        name: 'CellTag',
        options: useFeatureParityEventStatusTagOptions(),
      },
      field: 'status',
      title: $t('page.research.featureIntegrity.columns.status'),
      width: 150,
    },
    {
      cellRender: {
        name: 'CellTag',
        options: useFeatureParityStageTagOptions(),
      },
      field: 'stage',
