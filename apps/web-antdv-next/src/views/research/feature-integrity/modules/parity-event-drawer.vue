...
import {
  ...
  useFeatureParityEventStatusTagOptions,
...
const eventStatusOptions = useFeatureParityEventStatusTagOptions();
const featureCellStateOptions = useFeatureCellStateTagOptions();
const stageOptions = useFeatureParityStageTagOptions();
  ...
  >
    <div v-if="event" class="flex flex-col gap-4">
      <div class="flex flex-wrap gap-2">
        <Tag :color="findTagOption(eventStatusOptions, event.status)?.color">
          {{ findTagOption(eventStatusOptions, event.status)?.label }}
        </Tag>
        <Tag :color="findTagOption(stageOptions, event.stage)?.color">
          {{ findTagOption(stageOptions, event.stage)?.label }}
        </Tag>
      </div>
        ...
        <Descriptions :column="2" bordered size="small">
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/feature-integrity?run_id=${event.parity_run_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/quant/reports/${event.report_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/models?open=${event.model_version_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/jobs?result_ref=${event.parity_run_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/datasets?open=${event.training_dataset_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          <Descriptions :column="1" bordered size="small">
            ...
            >
              <Tag
                ...
                :color="
                  findTagOption(featureCellStateOptions, event.online.state)
                    ?.color
                "
              >
                {{
          ...
          <Descriptions :column="1" bordered size="small">
            ...
            >
              <Tag
                ...
                :color="
                  findTagOption(featureCellStateOptions, event.replay.state)
                    ?.color
                "
              >
                {{
