        ...
        <Descriptions :column="2" bordered size="small">
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/feature-integrity?run_id=${run.parity_run_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/jobs?result_ref=${run.parity_run_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
        ...
        <Descriptions :column="1" bordered size="small">
          ...
          >
            <EntityRouteLink
              mono
              :label="run.report_id"
              :to="`/quant/reports/${run.report_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/models?open=${run.model_version_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
          ...
          >
            <EntityRouteLink
              ...
              :to="`/research/datasets?open=${run.training_dataset_id}`"
            />
          </DescriptionsItem>
          <DescriptionsItem
