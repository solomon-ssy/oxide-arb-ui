      ...
      <Descriptions v-if="selectedRun" :column="2" bordered size="small">
        ...
        >
          <EntityRouteLink
            ...
            :to="`/research/data-reliability?module=feature-integrity&entity=parity-run&id=${selectedRun.parity_run_id}`"
          />
        </DescriptionsItem>
        <DescriptionsItem
        ...
        >
          <EntityRouteLink
            ...
            :to="`/research/lab?module=models&entity=model-version&id=${selectedRun.model_version_id}`"
          />
        </DescriptionsItem>
        <DescriptionsItem
        ...
        >
          <EntityRouteLink
            ...
            :to="`/research/lab?module=datasets&entity=training-dataset&id=${selectedRun.training_dataset_id}`"
          />
        </DescriptionsItem>
        <DescriptionsItem
