          ...
          <Descriptions :column="2" bordered size="small">
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/lab?module=models&entity=model-version&id=${report.model_version_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/lab?module=datasets&entity=training-dataset&id=${report.evaluation_dataset_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
