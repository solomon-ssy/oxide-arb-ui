          ...
          <Descriptions :column="2" bordered size="small">
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/lab?module=models&entity=model-version&id=${report.candidate_model_version_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/lab?module=models&entity=model-version&id=${report.baseline_model_version_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
