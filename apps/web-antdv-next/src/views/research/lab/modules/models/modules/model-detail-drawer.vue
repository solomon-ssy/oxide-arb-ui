...
import CpcvValidationPanel from '#/views/research/components/cpcv-validation-panel.vue';
      ...
      <div v-if="model" class="flex flex-col gap-4">
        ...
        <Card size="small">
          ...
          >
                  ...
                  >
                    ...
                    >
                      ...
                      <EntityRouteLink
                        ...
                        :to="`/research/lab?module=models&entity=model-version&id=${modelDetail.derivation.parent_model_version_id}`"
                      />
                      ·
                      <EntityRouteLink
                        mono
                        :label="modelDetail.derivation.calibration_artifact_id"
                        :to="`/research/learning-policy?module=calibration&entity=calibration-artifact&id=${modelDetail.derivation.calibration_artifact_id}`"
                      />
                    </template>
                  </DescriptionsItem>
                  <DescriptionsItem
                  ...
                  >
                    ...
                    >
                      <EntityRouteLink
                        ...
                        :to="`/research/lab?module=factors&entity=factor&id=${factor.factor_definition_id}`"
                      />
                    </DescriptionsItem>
                    <DescriptionsItem
                      :label="
            ...
            >
              <SubjectParityPanel :model-version-id="model.model_version_id" />
            </TabPane>
            <TabPane
              key="trade-policy"
                ...
                >
                  <span data-screenshot-volatile="true">
                    <EntityRouteLink
                      ...
                      :to="`/research/learning-policy?module=policies&entity=trade-policy&id=${model.trade_policy_artifact_id}`"
                    />
                  </span>
                </DescriptionsItem>
                <DescriptionsItem
          ...
          <Descriptions v-if="returnModel" :column="1" bordered size="small">
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/learning-policy?module=calibration&entity=calibration-artifact&id=${returnModel.calibrator_ref}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
              v-if="returnModel.calibration === 'calibrated'"
          ...
          <Descriptions :column="1" bordered size="small">
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/lab?module=specs&entity=model-spec&id=${model.model_spec_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
            ...
            >
              <EntityRouteLink
                ...
                :to="`/research/lab?module=datasets&entity=training-dataset&id=${model.training_dataset_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
