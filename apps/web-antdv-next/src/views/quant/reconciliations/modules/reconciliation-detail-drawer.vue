...
const resultTagOptions = useReconciliationResultTagOptions();
    ...
    <Spin :spinning="loading">
      <div v-if="reconciliation" class="flex flex-col gap-4">
        <div class="flex items-center justify-between gap-2">
          <Tag
            :color="
              findTagOption(resultTagOptions, reconciliation.result)?.color
            "
          >
            {{ findTagOption(resultTagOptions, reconciliation.result)?.label }}
          </Tag>
          ...
          <Descriptions :column="1" bordered size="small">
            ...
            >
              <EntityRouteLink
                ...
                :to="`/quant/execution-orders?open=${reconciliation.execution_order_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
            ...
            >
              <EntityRouteLink
                ...
                :to="`/quant/intents/${reconciliation.order_intent_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
