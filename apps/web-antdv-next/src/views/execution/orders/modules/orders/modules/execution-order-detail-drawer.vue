    ...
    >
      <div v-if="order" class="flex flex-col gap-4">
        <ObjectInspectorHeader
          :entity-id="order.execution_order_id"
          :statuses="[
            { name: 'ExecutionOrderState', value: order.state },
            { name: 'ExecutionOrderPhase', value: order.order_phase },
          ...
          <Descriptions :column="1" bordered size="small">
            ...
            >
              <EntityRouteLink
                ...
                :to="`/execution/orders?module=intents&entity=order-intent&id=${order.order_intent_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
            ...
            >
              <EntityRouteLink
                ...
                :to="`/trading/market-intelligence?module=live&entity=market&id=${order.market_id}`"
              />
            </DescriptionsItem>
            <DescriptionsItem
