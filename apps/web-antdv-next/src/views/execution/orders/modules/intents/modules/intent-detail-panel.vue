          ...
          >
            <span data-screenshot-volatile="true">
              <EntityRouteLink
                ...
                :to="`/trading/recommendations?module=queue&entity=recommendation&id=${intent.recommendation_id}`"
              />
            </span>
          </DescriptionsItem>
          <DescriptionsItem
    ...
    >
      <template #extra>
        <EntityRouteLink
          ...
          :to="`/execution/orders?module=orders&order_intent_id=${intent.order_intent_id}`"
        />
      </template>
      <Timeline
          ...
          <div class="flex flex-col gap-1">
            <div class="flex flex-wrap items-center gap-2">
              <EntityRouteLink
                ...
                :to="`/execution/orders?module=orders&entity=execution-order&id=${record.execution_order_id}`"
              />
              <Tooltip
