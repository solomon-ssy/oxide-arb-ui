...
export function useOperationLogColumns(
  ...
  return [
    ...
    {
      cellRender: { name: 'CellEnumTag', props: { enum: 'OperationCategory' } },
      field: 'category',
    ...
    {
      cellRender: { name: 'CellEnumTag', props: { enum: 'ResourceType' } },
      field: 'resource_type',
      width: 150,
    ...
    {
      cellRender: { name: 'CellEnumTag', props: { enum: 'OperationOutcome' } },
      field: 'outcome',
